...
pygame.display.set_caption("game gung")
...
# vonh lap ve game
while thoat==False:
    if menu==True and batdau==False and chienthang == False and thoat == False and thua == False:
        display.fill(black)
        a = pygame.draw.rect(display,While,(200,200,100,50))
        c = pygame.draw.rect(display,While,(200,260,100,50))
        win_text = fornt.render("MENU",True,While)
        muc_1 = fornt.render("Choi moi",True,black)
        muc_3 = fornt.render("Thoat",True,black)
    ...
    # duong di cua quai va auto tranh dan
        ...
        c = pygame.draw.rect(display,While,(200,260,100,50))
        win_text = fornt.render("MENU",True,While)
        muc_1 = fornt.render("Choi lai",True,black)
        muc_3 = fornt.render("Thoat",True,black)
        khung_text = win_text.get_rect()
        khung_muc_1 = muc_1.get_rect()
        khung_muc_3 = muc_3.get_rect()
